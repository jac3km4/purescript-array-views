...
import Test.ArrayView.Common (both)
...
checkArrayToView = do
  ...
  assertEqual
    { expected: (AV.use (AV.use :: Array Int -> ArrayView Int) :: ArrayView Int -> Array Int) (fromArray arr)
    , actual: arr
    }
  assertEqual
    { expected: (AV.use (AV.use :: ArrayView Int -> Array Int) :: Array Int -> ArrayView Int) arr
    , actual: fromArray arr
    }

  -- and between NonEmptyArrayArray and NonEmptyArrayView
  assertEqual
    { expected: (AV.use (AV.use :: NonEmptyArray Int -> NonEmptyArrayView Int) :: NonEmptyArrayView Int -> NonEmptyArray Int) (pure 0)
    , actual: pure 0
    }
  assertEqual
    { expected: (AV.use (AV.use :: NonEmptyArrayView Int -> NonEmptyArray Int) :: NonEmptyArray Int -> NonEmptyArrayView Int) (pure 0)
    , actual: pure 0
    }
